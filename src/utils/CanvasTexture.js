...
// 诙谐 · 「脑内小剧场」系列社课（占位内容，随时可替换为正式课程文案）
const SCHEMES_HUIXIE = [
  {
    title: "脑袋里住了个戏精",
    subtitle: "第 1 节 · 自我觉察",
    colorA: "#2b1a0e", colorB: "#c77d2b",
    tags: "觉察 · 元认知",
    desc: "为什么脑子里总有一个声音在加戏？认识那个 24 小时不间断评论你的「内心旁白」——它是怎么来的，又该怎样和它相处。",
    core: "为什么脑子里总有一个声音在加戏？",
    theory: [
      "元认知：人不仅有想法，还能「意识到自己在想」——这是人类独有的观察台。脑内的声音不是「你」，它只是不断广播的电台，而你是那个可以选择调台的人。",
      "认知融合与解离：当我们和想法「粘」在一起，一句「我不行」就是判决书；学会解离后，它只是一句路过大脑的台词——「我注意到，我正在产生一个我不行的想法」。"
    ],
    imagery: "脑内小剧场永不落幕，但你可以从舞台上的演员，慢慢退到观众席第一排——戏还演着，你已经能嗑着瓜子看了。"
  },
  {
    title: "尴尬瞬间回放键",
    subtitle: "第 2 节 · 反刍与自嘲",
    colorA: "#31101f", colorB: "#b23a75",
    tags: "聚光灯效应 · 幽默",
    desc: "三年前说错的那句话，为什么总在深夜准时重播？聚光灯效应告诉我们：没有那么多人记得你的糗事——除了你自己。",
    core: "为什么尴尬的记忆总在深夜重播？如何停止精神内耗式回放？",
    theory: [
      "聚光灯效应：人们高估他人对自己外表与行为的关注度近两倍。你记得三年的口误，当事人三分钟就忘了。",
      "幽默的防御与超越：自嘲不是贬低自己，而是主动给记忆「重新配音」——当你能笑着讲出那个瞬间，它就从「伤口」变成了「段子」。"
    ],
    imagery: "尴尬是大脑硬盘里的循环视频。夺回遥控器的方式不是删除它，而是给它配上一段滑稽的背景音乐。"
  },
  {
    title: "社恐不是病",
    subtitle: "第 3 节 · 社交焦虑",
    colorA: "#12263a", colorB: "#3f88c5",
    tags: "社交焦虑 · 暴露",
    desc: "一开口就大脑空白，是不是「有病」？社交焦虑是被夸大的自我保护——把「别人会怎么看我」换成「我想认识谁」。",
    core: "社交焦虑是缺陷还是保护？怎样在社交中不再大脑空白？",
    theory: [
      "焦虑的进化意义：被部落排斥在远古等于死亡，所以大脑把「社交评价」当作生死大事来报警。它不是故障，是灵敏度调得太高的警报器。",
      "安全行为与暴露：回避眼神、反复排练台词、提前离场——这些「安全行为」短期内止痛，长期内喂养焦虑。小剂量、渐进式的暴露才是脱敏的正路。"
    ],
    imagery: "社恐的人心里住着一位过度尽职的保安，见谁都拉警报。你不需要开除它，只需要告诉它：这位是客人，不是刺客。"
  },
  {
    title: "拖延是门行为艺术",
    subtitle: "第 4 节 · 拖延心理",
    colorA: "#1c2b17", colorB: "#6a994e",
    tags: "拖延 · 执行意图",
    desc: " deadline 前的效率奇迹是怎么回事？拖延不是懒，是用「短期情绪修复」换来的长期债务。",
    core: "为什么越重要的任务越拖？如何不靠意志力开始行动？",
    theory: [
      "拖延的情绪调节理论：拖延的本质不是时间管理失败，而是情绪管理失败——任务引发的不适（无聊、焦虑、自我怀疑）让人逃向即时快乐。",
      "执行意图：「如果…就…」计划能把行动触发器外包给情境——「如果到了周二晚上七点，我就打开文档写第一行」，比「我要努力」有效三倍以上。"
    ],
    imagery: "拖延的人都在和 deadline 合演一出行为艺术：前面大片留白，最后一笔惊魂。可惜观众只有你自己，而且票价是睡眠。"
  },
  {
    title: "生气前先数数羊",
    subtitle: "第 5 节 · 愤怒管理",
    colorA: "#3a1408", colorB: "#e36414",
    tags: "情绪粒度 · 暂停",
    desc: "愤怒上来那六秒，大脑里发生了什么？情绪粒度高的人不说「我气死了」，而说「我感到被轻视」。",
    core: "愤怒的几秒钟里大脑发生了什么？怎样不被情绪劫持？",
    theory: [
      "杏仁核劫持：强烈刺激下，情绪脑抢在理性脑上线前 0.5 秒接管身体——这就是「气头上说错话」的生理窗口。暂停六秒，等前额叶重新上线。",
      "情绪粒度：能细分情绪的人（委屈/失望/被误解/疲惫）比只会说「烦死了」的人，情绪调节能力显著更强。给情绪起名字，就是给它上笼头。"
    ],
    imagery: "愤怒是内心的鼓手突然加速。你夺不下鼓槌，但可以数拍子——一二三四五六，鼓点慢下来，曲子就还在你手里。"
  },
  {
    title: "熬夜的理由很奇怪",
    subtitle: "第 6 节 · 睡眠与自控",
    colorA: "#16121f", colorB: "#5a54a4",
    tags: "报复性熬夜 · 睡眠卫生",
    desc: "明明困得睁不开眼，为什么还要刷手机到凌晨？「报复性睡前拖延」是白天被剥夺的自由在深夜讨债。",
    core: "为什么明知该睡却不睡？如何把夜晚还给自己？",
    theory: [
      "报复性睡前拖延：白天自主时间越少的人，越倾向于在深夜「夺回控制权」——哪怕代价是明天的精力。熬夜的理由不奇怪，奇怪的是我们白天把自己排得太满。",
      "睡眠卫生：固定的入睡仪式、床只用来睡觉、睡前一小时调暗光线——大脑需要一条「下坡路」，而不是从信息高速直接冲进停车场。"
    ],
    imagery: "每一个舍不得睡的夜，都是白天那个没时间喘气的自己，在深夜里讨要一点点「属于我的时间」。把白天的自由还回来，夜晚自然就不必讨债了。"
  },
  {
    title: "比较是快乐的盗贼",
    subtitle: "第 7 节 · 社会比较",
    colorA: "#0f2a2e", colorB: "#2a9d8f",
    tags: "社会比较 · 自我同情",
    desc: "为什么刷完朋友圈会莫名低落？上行比较给人动力，也偷走快乐——关键看你拿什么和自己的什么比。",
    core: "为什么总是忍不住和别人比？怎样比较才不受伤？",
    theory: [
      "社会比较理论：人天生通过与他人比较来定位自己。上行比较（和更好的人比）激发动力也制造匮乏感；下行比较带来短暂安慰却容易滋生侥幸。",
      "自我同情三要素：善待自己（像对待好朋友那样对自己说话）、共通人性（受挫是每个人的出厂配置）、正念（不夸大也不压抑地看待痛苦）。"
    ],
    imagery: "你拿自己的幕后花絮，去比别人的高光剪辑，这场官司从一开始就不公平。快乐的盗贼进门时，自我同情是那个不给他开门的门卫。"
  },
  {
    title: "给未来的自己写封信",
    subtitle: "第 8 节 · 希望与意义",
    colorA: "#221a08", colorB: "#d4a017",
    tags: "希望理论 · 意义感",
    desc: "意义感不是被「找到」的，而是被「编织」的。希望 = 目标 + 路径思维 + 动力思维——三者都能练习。",
    core: "「人生的意义」这种问题，真的能讨论吗？",
    theory: [
      "希望理论（Snyder）：希望不是盲目乐观，它由三个可训练的部分组成——清晰的目标、看到多条通往目标的路径、以及相信自己能走下去的动力感。",
      "意义的编织：叙事心理学认为，人通过把经历讲成一个连贯的故事来获得意义感。同一段人生，可以讲成「连续剧式的失败」，也可以讲成「英雄之旅的第一章」。"
    ],
    imagery: "给未来的自己写一封信吧。写下今天的疲惫、没做完的梦和还在走的理由——多年以后拆开它，你会遇见一位久别重逢的老友。"
  }
];
...
export const COURSE_SETS = [
  ...
  { id: "huixie",  instructor: "诙谐", series: "脑内小剧场系列", frames: SCHEMES_HUIXIE }
];
